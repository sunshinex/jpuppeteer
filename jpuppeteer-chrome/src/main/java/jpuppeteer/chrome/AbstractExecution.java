...
public abstract class AbstractExecution implements ExecutionContext {
    ...
    private static void checkException(ExceptionDetails exceptionDetails) throws Exception {
    ...
    private ChromeBrowserObject call0(String declaration, boolean returnJSON, Object... args) throws Exception {
        ...
        if (
                RemoteObjectType.UNDEFINED.equals(response.getResult().getType())
    ...
    private ChromeBrowserObject eval0(String experssion, boolean returnJSON) throws Exception {
