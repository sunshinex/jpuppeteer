...
public class ChromeElement extends ChromeBrowserObject implements Element {
    ...
    public ChromeElement querySelector(String selector) throws Exception {
        ChromeBrowserObject object = frame.evaluate("function(selector){return this.querySelector(selector);}", this, selector);
    ...
    public List<ChromeElement> querySelectorAll(String selector) throws Exception {
        ChromeBrowserObject object = frame.evaluate("function(selector){return this.querySelectorAll(selector);}", this, selector);
    ...
    public boolean isIntersectingViewport() throws Exception {
        return frame.evaluate(ScriptConstants.ELEMENT_IS_INTERSECTING_VIEWPORT, Boolean.class);
    }
