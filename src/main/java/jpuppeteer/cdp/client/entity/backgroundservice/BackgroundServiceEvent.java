...
public class BackgroundServiceEvent {
    ...
    */
    ...
    public BackgroundServiceEvent(java.math.BigDecimal timestamp, String origin, String serviceWorkerRegistrationId, String service, String eventName, String instanceId, java.util.List<jpuppeteer.cdp.client.entity.backgroundservice.EventMetadata> eventMetadata) {
