...
public class VisibleSecurityState {
    ...
    */
    ...
    public VisibleSecurityState(String securityState, jpuppeteer.cdp.client.entity.security.CertificateSecurityState certificateSecurityState, jpuppeteer.cdp.client.entity.security.SafetyTipInfo safetyTipInfo, java.util.List<String> securityStateIssueIds) {
    ...
    public VisibleSecurityState(String securityState, java.util.List<String> securityStateIssueIds) {
        this.securityState = securityState;
