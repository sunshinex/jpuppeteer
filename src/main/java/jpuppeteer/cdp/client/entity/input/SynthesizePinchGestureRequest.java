...
public class SynthesizePinchGestureRequest {
    ...
    */
    ...
    public SynthesizePinchGestureRequest(java.math.BigDecimal x, java.math.BigDecimal y, java.math.BigDecimal scaleFactor, Integer relativeSpeed, String gestureSourceType) {
        this.x = x;
        this.y = y;
