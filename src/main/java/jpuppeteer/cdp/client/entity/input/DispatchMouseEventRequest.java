...
public class DispatchMouseEventRequest {
    ...
    */
    ...
    public DispatchMouseEventRequest(String type, java.math.BigDecimal x, java.math.BigDecimal y, Integer modifiers, java.math.BigDecimal timestamp, String button, Integer buttons, Integer clickCount, java.math.BigDecimal deltaX, java.math.BigDecimal deltaY, String pointerType) {
        this.type = type;
        this.x = x;
        this.y = y;
    ...
    public DispatchMouseEventRequest(String type, java.math.BigDecimal x, java.math.BigDecimal y) {
        this.type = type;
        this.x = x;
        this.y = y;
        this.modifiers = null;
