...
public class DispatchTouchEventRequest {
    ...
    */
    ...
    public DispatchTouchEventRequest(String type, java.util.List<jpuppeteer.cdp.client.entity.input.TouchPoint> touchPoints, Integer modifiers, java.math.BigDecimal timestamp) {
        this.type = type;
    ...
    public DispatchTouchEventRequest(String type, java.util.List<jpuppeteer.cdp.client.entity.input.TouchPoint> touchPoints) {
        this.type = type;
        this.touchPoints = touchPoints;
        this.modifiers = null;
        this.timestamp = null;
