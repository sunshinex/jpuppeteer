...
public class DispatchTouchEventRequest {
    ...
    */
    public final java.util.List<TouchPoint> touchPoints;
    ...
    */
    ...
    public DispatchTouchEventRequest(jpuppeteer.cdp.client.constant.input.DispatchTouchEventRequestType type, java.util.List<TouchPoint> touchPoints, Integer modifiers, java.math.BigDecimal timestamp) {
        this.type = type;
    ...
    public DispatchTouchEventRequest(jpuppeteer.cdp.client.constant.input.DispatchTouchEventRequestType type, java.util.List<TouchPoint> touchPoints) {
        this.type = type;
        this.touchPoints = touchPoints;
        this.modifiers = null;
        this.timestamp = null;
