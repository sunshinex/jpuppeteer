...
public class AXValueSource {
    ...
    */
    ...
    public AXValueSource(String type, jpuppeteer.cdp.client.entity.accessibility.AXValue value, String attribute, jpuppeteer.cdp.client.entity.accessibility.AXValue attributeValue, Boolean superseded, String nativeSource, jpuppeteer.cdp.client.entity.accessibility.AXValue nativeSourceValue, Boolean invalid, String invalidReason) {
        this.type = type;
        this.value = value;
    ...
    public AXValueSource(String type) {
        this.type = type;
        this.value = null;
        this.attribute = null;
