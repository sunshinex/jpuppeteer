...
public class Scope {
    ...
    */
    ...
    public Scope(String type, jpuppeteer.cdp.client.entity.runtime.RemoteObject object, String name, jpuppeteer.cdp.client.entity.debugger.Location startLocation, jpuppeteer.cdp.client.entity.debugger.Location endLocation) {
        this.type = type;
        this.object = object;
        this.name = name;
    ...
    public Scope(String type, jpuppeteer.cdp.client.entity.runtime.RemoteObject object) {
        this.type = type;
        this.object = object;
        this.name = null;
