...
public class BlockedSetCookieWithReason {
    ...
    */
    ...
    public BlockedSetCookieWithReason(java.util.List<String> blockedReasons, String cookieLine, jpuppeteer.cdp.client.entity.network.Cookie cookie) {
        this.blockedReasons = blockedReasons;
        this.cookieLine = cookieLine;
        this.cookie = cookie;
    }

    public BlockedSetCookieWithReason(java.util.List<String> blockedReasons, String cookieLine) {
        this.blockedReasons = blockedReasons;
        this.cookieLine = cookieLine;
        this.cookie = null;
    }
