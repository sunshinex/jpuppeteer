...
public class RequestInterceptedEvent {
    ...
    */
    ...
    public RequestInterceptedEvent(String interceptionId, jpuppeteer.cdp.client.entity.network.Request request, String frameId, String resourceType, Boolean isNavigationRequest) {
        this.interceptionId = interceptionId;
        this.request = request;
        this.frameId = frameId;
        this.resourceType = resourceType;
