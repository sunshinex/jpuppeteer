...
public class EmulateNetworkConditionsRequest {
    ...
    */
    ...
    public EmulateNetworkConditionsRequest(Boolean offline, java.math.BigDecimal latency, java.math.BigDecimal downloadThroughput, java.math.BigDecimal uploadThroughput, String connectionType) {
