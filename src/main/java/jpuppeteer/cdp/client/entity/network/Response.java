...
public class Response {
    ...
    */
    ...
    public Response(String url, Integer status, String statusText, java.util.Map<String, Object> headers, String mimeType, Boolean connectionReused, java.math.BigDecimal connectionId, java.math.BigDecimal encodedDataLength, String securityState) {
        this.url = url;
        this.status = status;
        this.statusText = statusText;
        this.headers = headers;
