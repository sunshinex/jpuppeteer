...
public class ResponseReceivedExtraInfoEvent {
    ...
    */
    ...
    public ResponseReceivedExtraInfoEvent(String requestId, java.util.List<jpuppeteer.cdp.client.entity.network.BlockedSetCookieWithReason> blockedCookies, java.util.Map<String, Object> headers, String headersText) {
    ...
    public ResponseReceivedExtraInfoEvent(String requestId, java.util.List<jpuppeteer.cdp.client.entity.network.BlockedSetCookieWithReason> blockedCookies, java.util.Map<String, Object> headers) {
        this.requestId = requestId;
        this.blockedCookies = blockedCookies;
        this.headers = headers;
