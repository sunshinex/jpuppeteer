...
public class JavascriptDialogOpeningEvent {
    ...
    */
    ...
    public JavascriptDialogOpeningEvent(String url, String message, String type, Boolean hasBrowserHandler, String defaultPrompt) {
        this.url = url;
    ...
    public JavascriptDialogOpeningEvent(String url, String message, String type, Boolean hasBrowserHandler) {
        this.url = url;
        this.message = message;
        this.type = type;
        this.hasBrowserHandler = hasBrowserHandler;
