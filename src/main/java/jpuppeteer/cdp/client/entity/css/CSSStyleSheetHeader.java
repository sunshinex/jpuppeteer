...
public class CSSStyleSheetHeader {
    ...
    */
    ...
    public CSSStyleSheetHeader(String styleSheetId, String frameId, String sourceURL, String sourceMapURL, String origin, String title, Integer ownerNode, Boolean disabled, Boolean hasSourceURL, Boolean isInline, java.math.BigDecimal startLine, java.math.BigDecimal startColumn, java.math.BigDecimal length, java.math.BigDecimal endLine, java.math.BigDecimal endColumn) {
    ...
    public CSSStyleSheetHeader(String styleSheetId, String frameId, String sourceURL, String origin, String title, Boolean disabled, Boolean isInline, java.math.BigDecimal startLine, java.math.BigDecimal startColumn, java.math.BigDecimal length, java.math.BigDecimal endLine, java.math.BigDecimal endColumn) {
        this.styleSheetId = styleSheetId;
        this.frameId = frameId;
        this.sourceURL = sourceURL;
