...
public class CSSMedia {
    ...
    */
    ...
    public CSSMedia(String text, String source, String sourceURL, jpuppeteer.cdp.client.entity.css.SourceRange range, String styleSheetId, java.util.List<jpuppeteer.cdp.client.entity.css.MediaQuery> mediaList) {
        this.text = text;
        this.source = source;
