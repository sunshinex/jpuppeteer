...
public class ConsoleAPICalledEvent {
    ...
    */
    ...
    public ConsoleAPICalledEvent(String type, java.util.List<jpuppeteer.cdp.client.entity.runtime.RemoteObject> args, Integer executionContextId, java.math.BigDecimal timestamp, jpuppeteer.cdp.client.entity.runtime.StackTrace stackTrace, String context) {
        this.type = type;
        this.args = args;
    ...
    public ConsoleAPICalledEvent(String type, java.util.List<jpuppeteer.cdp.client.entity.runtime.RemoteObject> args, Integer executionContextId, java.math.BigDecimal timestamp) {
        this.type = type;
        this.args = args;
        this.executionContextId = executionContextId;
        this.timestamp = timestamp;
