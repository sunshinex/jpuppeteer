...
public class ConsoleAPICalledEvent {
    ...
    * Call arguments.
    */
    public final java.util.List<RemoteObject> args;
    ...
    */
    ...
    public ConsoleAPICalledEvent(jpuppeteer.cdp.client.constant.runtime.ConsoleAPICalledEventType type, java.util.List<RemoteObject> args, Integer executionContextId, java.math.BigDecimal timestamp, StackTrace stackTrace, String context) {
        this.type = type;
        this.args = args;
    ...
    public ConsoleAPICalledEvent(jpuppeteer.cdp.client.constant.runtime.ConsoleAPICalledEventType type, java.util.List<RemoteObject> args, Integer executionContextId, java.math.BigDecimal timestamp) {
        this.type = type;
        this.args = args;
        this.executionContextId = executionContextId;
        this.timestamp = timestamp;
