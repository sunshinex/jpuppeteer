...
public class RequestEntriesResponse {
    ...
    */
    public final java.util.List<DataEntry> cacheDataEntries;
    ...
    */
    ...
    public RequestEntriesResponse(java.util.List<DataEntry> cacheDataEntries, java.math.BigDecimal returnCount) {
