...
public class DataEntry {
    ...
    */
    ...
    public DataEntry(String requestURL, String requestMethod, java.util.List<jpuppeteer.cdp.client.entity.cachestorage.Header> requestHeaders, java.math.BigDecimal responseTime, Integer responseStatus, String responseStatusText, String responseType, java.util.List<jpuppeteer.cdp.client.entity.cachestorage.Header> responseHeaders) {
