...
public class SetVirtualTimePolicyRequest {
    ...
    */
    ...
    public SetVirtualTimePolicyRequest(String policy, java.math.BigDecimal budget, Integer maxVirtualTimeTaskStarvationCount, Boolean waitForNavigation, java.math.BigDecimal initialVirtualTime) {
        this.policy = policy;
        this.budget = budget;
    ...
    public SetVirtualTimePolicyRequest(String policy) {
        this.policy = policy;
        this.budget = null;
